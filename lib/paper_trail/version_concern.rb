...
module PaperTrail
  module VersionConcern
    ...
    included do
      ...
      attr_accessible :item_type, :item_id, :event, :whodunnit, :object, :object_changes, :associated_type, :associated_id if PaperTrail.active_record_protected_attributes?
